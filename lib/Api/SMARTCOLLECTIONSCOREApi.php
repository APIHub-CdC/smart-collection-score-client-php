...
namespace SmartCollectionScore\Client\Api;
...
use SmartCollectionScore\Client\ApiException;
use SmartCollectionScore\Client\Configuration;
use SmartCollectionScore\Client\HeaderSelector;
use SmartCollectionScore\Client\ObjectSerializer;

class SMARTCOLLECTIONSCOREApi
{
    ...
    {
        $returnType = '\SmartCollectionScore\Client\Model\Respuesta';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\SmartCollectionScore\Client\Model\Respuesta',
                ...
                case 400:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\SmartCollectionScore\Client\Model\Errores',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
